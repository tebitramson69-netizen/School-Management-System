...
<head>
    ...
    <title><?= htmlspecialchars($student['full_name']) ?> - School Management System</title>
...
<body>
    <div class="dashboard-container">
        <header class="dashboard-header">
            ...
            <a href="<?= BASE_URL ?>/index.php?action=parent_dashboard" class="btn-logout">Back to Children</a>
        </header>
